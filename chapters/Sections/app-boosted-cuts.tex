...
\begin{figure}[htbp!]
\begin{center}
%\subfloat[Leading Higgs]{{%\includegraphics[width=5.5cm]{\boostedcutsfigpath roc_plot_scaled_lead.pdf} }}
\qquad
%\subfloat[Subleading Higgs]{{%\includegraphics[width=5.5cm]{\boostedcutsfigpath roc_plot_scaled_sublead.pdf} }}
...
\begin{figure}[htbp]
\begin{center}
%\subfloat[4 tag region]{{%\includegraphics[width=5.5cm]{\boostedcutsfigpath 4tag_mhh.png} }}
\qquad
%\subfloat[3 tag region]{{%\includegraphics[width=5.5cm]{\boostedcutsfigpath 3tag_mhh.png} }}
\qquad
%\subfloat[2 tag split region]{{%\includegraphics[width=5.5cm]{\boostedcutsfigpath 2tag_mhh.png} }}
...
\begin{figure}[htbp!]
\begin{center}
%\subfloat[Monte Carlo (Signal Region)]{{%\includegraphics[width=5.5cm]{\boostedcutsfigpath ptratio-alltag-mc.pdf} }}
\qquad
%\subfloat[Data (Inclusive)]{{%\includegraphics[width=5.5cm]{\boostedcutsfigpath ptratio-alltag-data.pdf} }}
...
\begin{figure}[htbp!]
\begin{center}
%\subfloat[Monte Carlo (Signal Region)]{{%\includegraphics[width=5.5cm]{\boostedcutsfigpath ptratio-2tag-mc.pdf} }}
\qquad
%\subfloat[Data (Inclusive)]{{%\includegraphics[width=5.5cm]{\boostedcutsfigpath ptratio-2tag-data.pdf} }}
