...
\begin{figure*}[htbp!]
\begin{center}
\includegraphics[angle=270, width=0.4\textwidth]{./figures/boosted/AppendixReweight/Compare/Data_FourTag_Sideband_directcompare_mHH_l_1.pdf}\\
\includegraphics[angle=270, width=0.4\textwidth]{./figures/boosted/AppendixReweight/Compare/Data_FourTag_Control_directcompare_mHH_l_1.pdf}\\
\includegraphics[angle=270, width=0.4\textwidth]{./figures/boosted/AppendixReweight/Compare/Data_FourTag_Signal_directcompare_mHH_l_1.pdf}
