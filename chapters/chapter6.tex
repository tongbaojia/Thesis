...
\footnotesize
\begin{center}
\caption{Expected yields for backgrounds in the $3b$ signal region, control region, and sideband region, along with the observed number of data events.  The signal predictions for \Grav $m=1.0, 1.5, 2.0$~\TeV\ with $c=1.0$.  For each predicted value, the uncertainty listed is statistical, without fit uncertainty.}
...
\footnotesize
\begin{center}
\caption{Expected yields for backgrounds in the $2bs$ signal region, control region, and sideband region, along with the observed number of data events.  The signal predictions for \Grav $m=1.0, 1.5, 2.0$~\TeV\ with $c=1.0$.  For each predicted value, the uncertainty listed is statistical, without fit uncertainty.}
