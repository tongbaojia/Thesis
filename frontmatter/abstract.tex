...
decaying to $hh$.%The coupling $k/\bar{M}_{\rm Pl}$,
%corresponding to the AdS curvature scale relative to the Planck scale, is chosen to be in the allowed range $1.0 - 2.0$.
%Second, the Type 2 two-Higgs doublet model (2HDM) is used with the neutral heavy CP-even $H$ scalar decays to $hh$.  
